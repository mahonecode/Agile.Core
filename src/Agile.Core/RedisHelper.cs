...
namespace Agile.Core
{
    ...
    {
        public static ILog Log = LogUtils.log;//日志记录

        
        private int _db = 0;
        //redis数据库连接字符串
        private string _conn = ConfigHelper.GetSectionValue("RedisConfig:ReadWriteHosts") ?? "127.0.0.1:6379";
        ...
        public ConnectionMultiplexer CacheConnection
        {
            get
            {
                ...
                {
                    Log.Error("RedisHelper->CacheConnection 出错\r\n" + ex.ToString());
                    return null;
                }
                return connection;
            }
        ...
        public string StringGet(string key)
        {
            ...
            {
                Log.Error("RedisHelper->StringGet 出错\r\n" + ex.ToString());
                return null;
            }
        }
        ...
        public string[] StringGetMany(string[] keyStrs)
        {
            ...
            {
                Log.Error("RedisHelper->StringGetMany 出错\r\n" + ex.ToString());
                return null;
            }
        }
        /// <summary>
